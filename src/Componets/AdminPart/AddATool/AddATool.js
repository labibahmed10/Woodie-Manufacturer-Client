            ...
            <form action="" onSubmit={handleAddProduct}>
               ...
               <div className="flex lg:justify-between lg:flex-row flex-col lg:space-y-0 space-y-2">
                  ...
                  <div class="form-control">
                     ...
                     <input name="avlQuan" type="number" placeholder="quantity" class="lg:w-[25rem] w-full input input-bordered " />
                  </div>
               </div>
               ...
               <div className="flex lg:justify-between lg:flex-row flex-col lg:space-y-0 space-y-2">
                  <div class="form-control">
                     ...
                     <input name="moq" type="number" placeholder="Moq" class="input input-bordered lg:w-[25rem] w-full" />
                  </div>
                  <div class="form-control">
                     <label class="label">
                        <span class="label-text font-semibold">Price Per Unit($)?</span>
                     </label>
                     <input name="pPerUnit" type="number" placeholder="price" class="input input-bordered lg:w-[25rem] w-full" />
                  </div>
               </div>
